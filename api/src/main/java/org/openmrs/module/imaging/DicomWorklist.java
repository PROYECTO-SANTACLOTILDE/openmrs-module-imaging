...
public class DicomWorklist extends BaseOpenmrsData implements java.io.Serializable {
    ...
    public DicomWorklist(int worklistID, String accessionNumber, OrthancConfiguration orthancConfiguration, DicomStudy study, Patient mrPatient, String referringPhysician,
                         String studyDescription, String stepStartDate, String stepStartTime, String modality, String reqProcedureID, String reqProcedureDescription,
                         String stationAETitle, String performingPhysician, String procedureStepLocation, String preMedication, String specialNeeds) {
